...
public class Pantalla_de_login {
    public static void main(String[] args) {
        ...
        loginLabel.setBounds(90, 180, 150, 25); // 100 es la nueva altura de la imagen
        loginPanel.add(loginLabel);
        loginLabel.setFont(new Font("Arial", Font.BOLD, 20)); // Fuente en negrita y tamaño 16

        // User label
        JLabel usernameLabel = new JLabel("Usuario");
        usernameLabel.setBounds(50, 250, 80, 25);
        loginPanel.add(usernameLabel);

        // Password label
        JLabel passwordLabel = new JLabel("Contraseña");
        passwordLabel.setBounds(50, 290, 80, 25);
        ...
        registrationPanel.setBounds(50, 425, 200, 25); // Ajustar el ancho

        // Label ¿Aún no te has registrado? con fuente más pequeña
        JLabel registerLabel = new JLabel("¿Aún no te has registrado?");
        registerLabel.setFont(new Font("Arial", Font.PLAIN, 8)); // Tamaño de fuente más pequeño
